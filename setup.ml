...
(* OASIS_START *)
(* DO NOT EDIT (digest: c026567421ccf9becdbe3bad2d446bb5) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_omitie", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/travisbrady/omitie";
            ...
            [
                      ...
                      bs_cclib =
                        [
                           ...
                           (OASISExpr.ETest ("system", "linux"),
                             ["-Xlinker"; "--no-as-needed"; "-lmitie"]);
                           (OASISExpr.ENot
                              (OASISExpr.ETest ("system", "linux")),
                             ["-lmitie"])
                        ];
                      bs_dlllib = [(OASISExpr.EBool true, ["-lmitie"])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
                   {
                      lib_modules = ["Mitie"; "Omitie"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "omitie";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_omitie.ml"});
               Test
                 ({
                     cs_name = "test_omitie";
                     cs_data = PropList.Data.create ();
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Compile opium-based web server";
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "webserver", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples";
                      bs_compiled_object = Best;
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\026 ë\000Ñ/8âÄÌþÿµÿ\132Ñ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
